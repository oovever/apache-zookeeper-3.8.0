    ...
    public Set<Watcher> materialize(
        ...
        case None: //新建连接类型
            if (defaultWatcher != null) {
                result.add(defaultWatcher); //添加默认的watcher 新建zk时候可以加
            }

            boolean clear = disableAutoWatchReset && state != Watcher.Event.KeeperState.SyncConnected; //使用后是否删除
            synchronized (dataWatches) {
        ...
        case NodeCreated:
            ...
            break;
        case NodeChildrenChanged: //子节点修改
            synchronized (childWatches) {
