...
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    protected void setupRequestProcessors() {
        RequestProcessor finalProcessor = new FinalRequestProcessor(this); //创建finalProcessor
        ...
        firstProcessor = new LeaderRequestProcessor(this, prepRequestProcessor); // 责任链Processor
